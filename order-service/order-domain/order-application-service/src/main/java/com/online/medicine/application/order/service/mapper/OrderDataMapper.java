...
public class OrderDataMapper {
    ...
    private List<com.online.medicine.domain.order.service.domain.entity.OrderItem> orderItemsToOrderItemEntities(
            List<com.online.medicine.application.order.service.dto.create.OrderItem> orderItems) {
        return orderItems.stream()
                .map(orderItem ->
                        com.online.medicine.domain.order.service.domain.entity.OrderItem.builder()
                                .medicine(new Medicine(new MedicineId(orderItem.getMedicineId())))
