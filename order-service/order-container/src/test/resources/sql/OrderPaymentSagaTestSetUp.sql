insert into "orders".orders(id, customer_id, pharmacy_id, tracking_id, price, order_status, failure_messages)
...
insert into "orders".order_items(id, order_id, medicine_id, price, quantity, sub_total)
values(1, 'd215b5f8-0249-4dc5-89a3-51fd148cfb17', 'd215b5f8-0249-4dc5-89a3-51fd148cfb47', 100.00, 1, 100.00);

insert into "orders".order_address(id, order_id, street, postal_code, city)
values('d215b5f8-0249-4dc5-89a3-51fd148cfb15', 'd215b5f8-0249-4dc5-89a3-51fd148cfb17', 'test street', '1000AA', 'test city');

insert into "orders".payment_outbox(id, saga_id, created_at, type, payload, outbox_status, saga_status, order_status, version)
