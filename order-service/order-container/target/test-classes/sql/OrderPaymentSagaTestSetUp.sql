insert into "order".orders(id, customer_id, pharmacy_id, tracking_id, price, order_status, failure_messages)
...
insert into "order".order_items(id, order_id, medicine_id, price, quantity, sub_total)
