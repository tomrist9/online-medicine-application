...
curl --location --request DELETE 'localhost:8083/connectors/order-pharmacy-connector'
curl --location --request DELETE 'localhost:8083/connectors/payment-order-connector'
curl --location --request DELETE 'localhost:8083/connectors/pharmacy-order-connector'
