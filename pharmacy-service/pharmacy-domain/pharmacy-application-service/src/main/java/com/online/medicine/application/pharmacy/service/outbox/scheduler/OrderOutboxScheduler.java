package com.online.medicine.application.pharmacy.service.outbox.scheduler;
...
public class OrderOutboxScheduler implements OutboxScheduler {
    ...
    private final PharmacyApprovalResponseMessagePublisher responseMessagePublisher;

    public OrderOutboxScheduler(OrderOutboxHelper orderOutboxHelper,
                                PharmacyApprovalResponseMessagePublisher responseMessagePublisher) {
